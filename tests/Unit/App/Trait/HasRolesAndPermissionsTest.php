...
class HasRolesAndPermissionsTest extends TestCase
{
    ...
    {
        $this->user = $this->user->givePermissionsTo(['manage-events']);
        $this->user->refresh();

        $this->assertTrue($this->user->hasPermissionTo('manage-events'));
    }
    ...
    public function test_refresh_user_permissions(): void
    {
        ...
        $permission = $this->getPermissionBySlug('manage-events');
